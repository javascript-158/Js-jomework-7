...
let someSentss = "kamskd kamdkmaskmd kamskdm kamsdkma kasmdkamqkwkermmk asdkmaksdkmmkas"; // სიტყვების მთვლელი მარტივად

console.log(someSentss.split(' ').length)

let someSents = "kamskd kamdkmaskmd kamskdm kamsdkma kasmdkamqkwkermmk asdkmaksdkmmkas"; // ასოების ტვლელი მარტივად

let allWords = 0;

for (let sent of someSents.split(" ")) {
    allWords += sent.length
}
